...
print(imgLgray.shape)
print(disparity_map[0][0])
print(type(disparity_map))
print(np.amin(disparity_map, axis=None))
print(np.amax(disparity_map, axis = None))
plt.show()
...
points_3D = cv2.reprojectImageTo3D(disparity_map, Q, handleMissingValues=False)# X, Y, Z for each point(u, v)
